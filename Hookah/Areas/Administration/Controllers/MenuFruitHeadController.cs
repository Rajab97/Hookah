...
namespace Hookah.Areas.Administration.Controllers
{
    ...
    [Authorize]
    public class MenuFruitHeadController : BaseController
    {
        public const string Name = "MenuFruitHead";
        private readonly IMenuFruitHeadServiceFacade _serviceFacade;

        public MenuFruitHeadController(IMenuFruitHeadServiceFacade serviceFacade)
        {
        ...
        {
            var model = new MenuFruitHeadViewModel();
        ...
        public async Task<IActionResult> Save(MenuFruitHeadViewModel model)
        {
