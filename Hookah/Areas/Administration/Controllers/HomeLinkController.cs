...
namespace Hookah.Areas.Administration.Controllers
{
    ...
    [Authorize]
    public class HomeLinkController : BaseController
    {
        public const string Name = "HomeLink";
        private readonly IHomeLinkServiceFacade _serviceFacade;

        public HomeLinkController(IHomeLinkServiceFacade serviceFacade)
        {
        ...
        {
            var model = new HomeLinkViewModel();
        ...
        public async Task<IActionResult> Save(HomeLinkViewModel model)
        {
